...
class MainActivity : BaseVbActivity<ActivityMainBinding>() {
    ...
    private fun checkUpdate() {
        UpdateChecker.check(this, object : UpdateChecker.UpdateCallback {
            override fun onUpdateAvailable(newVersionName: String, changelog: String, downloadUrl: String) {
                XPopup.Builder(mContext)
                    .asCustom(UpdateDialog(mContext, newVersionName, changelog, downloadUrl))
                    .show()
            }
