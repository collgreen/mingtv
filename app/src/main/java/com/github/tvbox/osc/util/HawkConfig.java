...
public class HawkConfig {
    ...
    /** ProxyTester 选出的最佳代理下标（对应 GitHubUtils.PROXY_PREFIXES） */
    public static final String GITHUB_PROXY_IDX = "github_proxy_idx";
    /** 上次代理测速的时间戳（毫秒），用于判断缓存是否在 12h 有效期内 */
    public static final String GITHUB_PROXY_CACHE_TIME = "github_proxy_cache_time";
}